basepath = 'Z:\SUN-IN-Petersen-lab\EphysData\MartynasDervinis\ms-preliminary\03_data\PP02\PP02_2020-07-23_12-12-45';
...
%% Behavior processing
scaling_factor = 0.5;
offset_origin = [0,-2.5,0];

offset_rigid_body = [0,-2.5,0]; % Not implemented yet
