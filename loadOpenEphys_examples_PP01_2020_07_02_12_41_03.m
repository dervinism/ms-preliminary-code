basepath = 'Z:\SUN-IN-Petersen-lab\EphysData\MartynasDervinis\ms-preliminary\03_data\PP01\PP01_2020-07-02_12-41-03';
...
% 
% linear_track = loadOptitrack('session',session,'dataName','linear_track','offset_origin',offset_origin,'scaling_factor',scaling_factor);
% linear_track.timestamps = linear_track.timestamps + session.epochs{4}.startTime;
% 
% 
% %% maze parameters
% maze = {};
