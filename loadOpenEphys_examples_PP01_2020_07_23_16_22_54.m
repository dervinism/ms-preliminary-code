basepath = 'Z:\SUN-IN-Petersen-lab\EphysData\MartynasDervinis\ms-preliminary\03_data\PP01\PP01_2020-07-23_16-22-54';
...
% 
% linear_track = loadOptitrack('session',session,'dataName','linear_track','offset',offset_origin,'scaling_factor',scaling_factor);
% 
% 
% % %% maze parameters
% % maze = {};
