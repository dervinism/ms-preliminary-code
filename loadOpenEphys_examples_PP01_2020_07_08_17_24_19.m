basepath = 'Z:\SUN-IN-Petersen-lab\EphysData\MartynasDervinis\ms-preliminary\03_data\PP01\PP01_2020-07-08_17-24-19';
...
% maze.pos_x_limits = [-10,10]; % arm delimiters in x-coords
% maze.pos_y_limits = [-40,44]; % arm delimiters in y-coords
% 
% subplot(1,2,1)
% plot_ThetaMaze(maze)
% 
